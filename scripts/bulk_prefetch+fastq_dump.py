...
download_dir = "/mnt/d/raw_data_bulkRNA/"
fastq_dir = "/mnt/d/fastq_output/"
...
for sra_id in sra_numbers:
    print(f"\n=== Downloading: {sra_id} ===")
    prefetch_cmd = f"prefetch {sra_id} --output-directory {download_dir}"
...
for sra_id in sra_numbers:
    sra_path = f"{download_dir}{sra_id}/{sra_id}.sra"
    print(f"\n=== Generating FASTQ for: sra_id, ===")
    fastq_dump_cmd = (
        f"fastq-dump --outdir {fastq_dir} --gzip --skip-technical "
